...
- если терм не встречается в документе, его вклад в score равен 0;
- если терм встречается 1 раз, вклад по tf равен 1;
- если терм встречается много раз, рост веса замедляется логарифмом;
- редкие термы получают больший вес за счёт idf.
